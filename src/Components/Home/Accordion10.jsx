...
function Accordion10() {
  ...
  return (
    <>
<hr />
<section class="bg-light py-3 py-md-5 main-div">
  <div class="container">
    <div class="row gy-5 gy-lg-0 align-items-lg-center">
      <div class="col-12 col-lg-6">
        <img class="img-fluid rounded" loading="lazy" src="https://tse4.mm.bing.net/th?id=OIP.bp4YK6RkaRvIaMeQH72D9wHaE7&pid=Api&P=0&h=180" alt="How can we help you?"/>
      </div>
      <div class="col-12 col-lg-6">
