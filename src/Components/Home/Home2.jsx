  ...
  return (
    <>
      ...
      <div className='row d-flex justify-content-center'>
          ...
          <div class="card col-lg-3  m-2 " style={{width: '22rem'}}>
            <img src="https://tse1.mm.bing.net/th?id=OIP.iVOnCBBWSPjlxqfeo82Q7gHaEK&pid=Api&P=0&h=180" class="card-img-top " style={{height: '14rem'}} alt="..." />
            <div class="card-body">
          ...
          <div class="card col-lg-3 m-2" style={{width: '22rem'}}>
            <img src="https://tse4.mm.bing.net/th?id=OIP.2zt71lv5oK7DOlZSSZbhiQHaE8&pid=Api&P=0&h=180" class="card-img-top " style={{height: '14rem'}} alt="..." />
            <div class="card-body">
          ...
          <div class="card col-lg-3 m-2" style={{width: '22rem'}}>
            <img src="https://tse2.explicit.bing.net/th?id=OIP.FuywT3Dp9SzeegGXOjL3bAAAAA&pid=Api&P=0&h=180" class="card-img-top " style={{height: '14rem'}} alt="..." />
            <div class="card-body">
